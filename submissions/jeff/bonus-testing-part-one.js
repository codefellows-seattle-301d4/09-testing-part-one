...
var pickRandomAnimal = function(){
  nextAnimal = favoriteAnimals[randomNumber()];
  console.log('Random animal: ' + nextAnimal);
  return nextAnimal;
};
...
function findAnimal(animal) {
  if (animal === nextAnimal) {
    console.log('Matching animal in array: ' + animal);
    return animal;
  };
}
...
expect(
  ...
  'nextAnimal should equal one of the following: ' + favoriteAnimals + '. But currently equals ' + nextAnimal,
  'nextAnimal equals ' + nextAnimal + ' and matches an element in the favoriteAnimals array!');
