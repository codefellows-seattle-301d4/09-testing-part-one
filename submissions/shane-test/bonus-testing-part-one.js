...
nextAnimal = function(){
  v = favoriteAnimals[Math.floor(Math.random() * favoriteAnimals.length)];
  return v;
};
  ...
  /* TODO:
      ...
      expect(
        nextAnimal !== favoriteAnimals.indexOf(nextAnimal), 'nextAnimal = ' + nextAnimal() + ', it didn\'t work :(', 'nextAnimal = ' + nextAnimal() + ', it worked! :)'
      );
