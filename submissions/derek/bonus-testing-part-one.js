...
expect( favoriteAnimals.indexOf(nextAnimal) !== -1, nextAnimal + ' was not found in the array: [' + favoriteAnimals.join(', ') + '].', nextAnimal + ' was found in the array: [' + favoriteAnimals.join(', ') + '] at position ' + favoriteAnimals.indexOf(nextAnimal) );
