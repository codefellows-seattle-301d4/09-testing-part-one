...
expect(
  ...
  'my test failed!  The next animal should have been one of ' + favoriteAnimals + ', but currently is ' + nextAnimal, + 'my test passed!' + nextAnimal + ' equals one of ' + favoriteAnimals
);
