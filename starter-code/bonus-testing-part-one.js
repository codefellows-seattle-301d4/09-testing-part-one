...
var favorite = favoriteAnimals[Math.floor(Math.random()*favoriteAnimals.length)];
...
expect(
  favoriteAnimals.indexOf(favorite) !== -1,
  'something went wrong your favorite is listed as: ' + favorite,
  'you chose a good animal, ' + favorite
);
